...
Set `refresh_interval_ms` to return once with `CAT_ACTION_REFRESH` after that interval while preserving focus and scroll. Leave it at zero to disable timed refresh.
